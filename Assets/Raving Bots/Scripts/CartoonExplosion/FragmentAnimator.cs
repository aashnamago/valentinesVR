...
namespace RavingBots.CartoonExplosion
{
	public abstract class FragmentAnimator : BaseAnimator
	{
		...
		public override void OnPlay()
		{
			...
			ParticleSystem.startSize = FX.Size * ParticleSize;
			ParticleSystem.startLifetime = FX.Duration * (1f - StartDelay) * MaxLifetime;
			ParticleSystem.startSpeed = FX.Size * StartSpeed / FX.Duration;
